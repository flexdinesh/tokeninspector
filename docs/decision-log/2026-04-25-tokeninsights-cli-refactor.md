---
title: Maintainable Go+SQLite patterns for tokeninsights-cli
...
date: 2026-04-25
slug: tokeninsights-cli-refactor
status: implemented
tags:
  - go
  - sqlite
  ...
  - sql-aggregation
related_paths:
  - cli/cmd/tokeninsights-cli/main.go
...
- Flat `main.go` → `cmd/tokeninsights-cli/main.go` + `internal/db/` + `internal/cli/`
